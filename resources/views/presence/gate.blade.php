        ...
        <div class="col-12">
          <div class="card ep-card overflow-hidden">
            ...
            <div class="card-body p-4 text-center">
              ...
              @if(isset($error))
                <div class="alert alert-danger text-white text-center shadow mb-3">{{ $error }}</div>
                <div class="text-center">
                  <a href="{{ route('home') }}" class="btn btn-outline-secondary mb-0">Kembali ke Beranda</a>
                </div>
              @else
                <p class="text-sm text-muted mb-4">Masukkan password event dari penyelenggara untuk membuka formulir presensi.</p>
