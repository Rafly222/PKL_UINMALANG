    ...
    <div class="modal-content border-0 ep-card">
      ...
      <div class="modal-body text-start p-4">
        <form action="{{ route('admin.event.store') }}" method="POST">
          ...
          <div class="input-group mb-3" id="admin-event-password-group" style="display: none;">
...
<script>
  document.addEventListener('DOMContentLoaded', () => {
    ...
    if (adminAccessType && adminEventPasswordGroup) {
      adminAccessType.addEventListener('change', () => {
        adminEventPasswordGroup.style.display = adminAccessType.value === 'privat' ? 'flex' : 'none';
      });
    }

    const adminAddCustomFieldBtn = document.getElementById('admin-add-custom-field');
    if (adminAddCustomFieldBtn) {
      adminAddCustomFieldBtn.addEventListener('click', () => {
    ...
    if (document.getElementById('events-table-admin') && typeof simpleDatatables !== 'undefined') {
